...
- 年级-学科支持初一语文、初一/初二/初三英语及初一/初二/初三数学；
- 课包属性支持全年包，以及暑秋、秋寒、寒春、春暑四类半年包；全年包追踪 M1–M12，半年包追踪 M1–M6；
- 周期前增加“年级-学科”“课包属性”和“开课时间（年月日）”筛选；开课日期优先作为 M1 起算日，缺失时回退到购买日期；
...
- “孩子不喜欢学”等具体归因项可继续内嵌同类微信原声证据，直接展示分类标签、真实学习行为与匹配结论；
